...
func AesDecrypt(crypted, key []byte) []byte {
	...
	origData = PKCS5UnPaddingECB(origData)
...
func AesEncryptECBUrlEncode(src, key string) string {
	...
	cryptedString := UrlEncode(base64.StdEncoding.EncodeToString(crypted))
	fmt.Println("base64 result:", UrlEncode(base64.StdEncoding.EncodeToString(crypted)))
